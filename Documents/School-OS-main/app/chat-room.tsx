...
const INITIAL_SPACES: ChatRoom[] = [
  {
    ...
    participants: [
      { id: 'dev:teacher', name: 'Sadahana', role: 'Teacher', online: true, status: 'Grading IA drafts' },
  ...
  },
  {
    ...
    participants: [
      { id: 'dev:admin', name: 'Nithin Selvaraj', role: 'Admin', online: true },
      { id: 'dev:teacher', name: 'Sadahana', role: 'Teacher', online: true },
      { id: 'dev:student', name: 'Nithin Selvaraj', role: 'Student', online: true },
    ],
  },
  {
...
const INITIAL_DMS: ChatRoom[] = [
  ...
  },
  {
    ...
    participants: [
      { id: 'dev:teacher', name: 'Sadahana', role: 'Teacher', online: true, status: 'Office hours in Lab 101' },
      { id: 'dev:student', name: 'Nithin Selvaraj', role: 'Student', online: true },
    ],
  },
  {
...
const INITIAL_MESSAGES: Record<string, ChatMessage[]> = {
  ...
  'space-physics-hl': [
    ...
    },
    {
      ...
      reactions: { '🎉': ['Sadahana', 'Emma Wilson'] },
      status: 'read',
    },
    {
      id: 'msg-p-5',
