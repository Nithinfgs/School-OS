...
export function StudentContactCard({
  ...
  student: StudentContactData | { name: string; data?: Record<string, any>; id?: string };
  onClose?: () => void;
...
========================================`.trim();
  ...
  return (
    <div className={`student-contact-card bg-slate-900 border border-slate-800 text-slate-100 rounded-2xl shadow-2xl overflow-hidden ${compact ? 'p-4' : 'p-6'} transition-all`}>
      {/* Top Hero Banner */}
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2 mb-1">
              <h2 className="text-xl font-bold tracking-tight text-white m-0">{data.name}</h2>
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs text-slate-400">
              <span>ID: <b className="text-slate-200">{data.studentId || data.admissionNumber || 'WB-STU'}</b></span>
              <span>·</span>
              <span>Class: <b className="text-slate-200">{data.class || data.grade || 'DP2'}</b></span>
              <span>·</span>
              <span>Homeroom: <b className="text-slate-200">{data.homeroom || 'DP-2'}</b></span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 self-start sm:self-center">
          ...
          >
            {copiedKey === 'fullSummary' ? (
              <>
                <Check size={14} className="text-emerald-400 mr-1.5" /> Copied summary!
              </>
            ) : (
              <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
        ...
        <div className="bento-card bg-slate-950/60 border border-slate-800/80 rounded-xl p-4 flex flex-col justify-between hover:border-slate-700/80 transition-all">
          <div>
            <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-slate-400 mb-3">
              <User size={14} className="text-emerald-400" /> Student Direct Info
            </div>
            <div className="space-y-2.5 text-xs">
              <div>
                ...
                <div className="flex items-center justify-between gap-2 mt-0.5">
                  ...
                  <button
                    onClick={() => copyToClipboard(data.studentEmail || '', 'studentEmail')}
                    className="text-slate-400 hover:text-white p-1 rounded hover:bg-slate-800 transition-colors"
                    title="Copy student email"
                  >
                    {copiedKey === 'studentEmail' ? <Check size={12} className="text-emerald-400" /> : <Copy size={12} />}
                  </button>
                </div>
              </div>

              <div>
                <div className="text-[11px] text-slate-400 font-medium">Student Mobile</div>
                <div className="flex items-center justify-between gap-2 mt-0.5">
                  <a
                  ...
                  <button
                    onClick={() => copyToClipboard(data.studentPhone || '', 'studentPhone')}
                    className="text-slate-400 hover:text-white p-1 rounded hover:bg-slate-800 transition-colors"
                    title="Copy student phone"
                  >
                    {copiedKey === 'studentPhone' ? <Check size={12} className="text-emerald-400" /> : <Copy size={12} />}
                  </button>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 pt-1 border-t border-slate-800/60">
                <div>
                  ...
                  <div className="text-slate-200 font-medium mt-0.5">{data.dateOfBirth || '2008-04-14'}</div>
                </div>
                <div>
                  <div className="text-[11px] text-slate-400 font-medium">Gender</div>
                  <div className="text-slate-200 font-medium mt-0.5">{data.gender || 'Male'}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-3 pt-2.5 border-t border-slate-800/80 text-[11px] text-slate-400 flex items-start gap-1.5">
            ...
            <span className="truncate">{data.address || 'Chennai, Tamil Nadu'}</span>
          </div>
        </div>
            ...
            <div className="space-y-2.5 text-xs">
              <div>
                ...
                {data.primaryParentOccupation && (
                  <div className="text-[11px] text-slate-400 flex items-center gap-1 mt-0.5">
                    <Briefcase size={11} className="text-slate-400" /> {data.primaryParentOccupation}
                  </div>
                )}
              </div>
              ...
              <div>
                ...
                <div className="flex items-center justify-between gap-2 mt-0.5">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      onClick={() => copyToClipboard(data.primaryParentPhone || '', 'pParentPhone')}
                      className="text-slate-400 hover:text-white p-1 rounded hover:bg-slate-800 transition-colors"
                      title="Copy primary parent phone"
                    >
                      {copiedKey === 'pParentPhone' ? <Check size={12} className="text-emerald-400" /> : <Copy size={12} />}
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center justify-between gap-2 mt-0.5">
                  ...
                  <button
                    onClick={() => copyToClipboard(data.primaryParentEmail || '', 'pParentEmail')}
                    className="text-slate-400 hover:text-white p-1 rounded hover:bg-slate-800 transition-colors"
                    title="Copy primary parent email"
                  >
                    {copiedKey === 'pParentEmail' ? <Check size={12} className="text-emerald-400" /> : <Copy size={12} />}
                  </button>
                </div>
              </div>
            </div>
        ...
        <div className="bento-card bg-slate-950/60 border border-slate-800/80 rounded-xl p-4 flex flex-col justify-between hover:border-slate-700/80 transition-all">
          <div>
            <div className="flex items-center justify-between gap-2 mb-3">
              <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-slate-400">
                <Users size={14} className="text-purple-400" /> Secondary Guardian
              </div>
            ...
            <div className="space-y-2.5 text-xs">
              <div>
                ...
                {data.secondaryParentOccupation && (
                  <div className="text-[11px] text-slate-400 flex items-center gap-1 mt-0.5">
                    <Briefcase size={11} className="text-slate-400" /> {data.secondaryParentOccupation}
                  </div>
                )}
              </div>
              ...
              <div>
                ...
                <div className="flex items-center justify-between gap-2 mt-0.5">
                  ...
                  <button
                    onClick={() => copyToClipboard(data.secondaryParentPhone || '', 'sParentPhone')}
                    className="text-slate-400 hover:text-white p-1 rounded hover:bg-slate-800 transition-colors"
                    title="Copy secondary parent phone"
                  >
                    {copiedKey === 'sParentPhone' ? <Check size={12} className="text-emerald-400" /> : <Copy size={12} />}
                  </button>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center justify-between gap-2 mt-0.5">
                  ...
                  <button
                    onClick={() => copyToClipboard(data.secondaryParentEmail || '', 'sParentEmail')}
                    className="text-slate-400 hover:text-white p-1 rounded hover:bg-slate-800 transition-colors"
                    title="Copy secondary parent email"
                  >
                    {copiedKey === 'sParentEmail' ? <Check size={12} className="text-emerald-400" /> : <Copy size={12} />}
                  </button>
                </div>
              </div>
            </div>
        ...
        <div className="bento-card bg-slate-950/60 border border-slate-800/80 rounded-xl p-4 flex flex-col justify-between hover:border-slate-700/80 transition-all">
          <div>
            <div className="flex items-center justify-between gap-2 mb-3">
              <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-slate-400">
                <GraduationCap size={14} className="text-amber-400" /> Class / Homeroom Teacher
              </div>
            ...
            <div className="space-y-2.5 text-xs">
              ...
              <div>
                <div className="text-[11px] text-slate-400 font-medium">Teacher Email</div>
                <div className="flex items-center justify-between gap-2 mt-0.5">
                  <a
                  ...
                  <button
                    onClick={() => copyToClipboard(data.homeroomTeacherEmail || 'teacher.dev@schoolos.local', 'teacherEmail')}
                    className="text-slate-400 hover:text-white p-1 rounded hover:bg-slate-800 transition-colors"
                  >
                    {copiedKey === 'teacherEmail' ? <Check size={12} className="text-emerald-400" /> : <Copy size={12} />}
                  </button>
                </div>
              </div>

              <div>
                <div className="text-[11px] text-slate-400 font-medium">Teacher Extension / Phone</div>
          ...
          <div className="mt-3 pt-2.5 border-t border-slate-800/80 flex items-center justify-between text-[11px]">
            ...
            <span className="text-slate-200 font-medium">Lab 101 / Room 204</span>
          </div>
        </div>
        ...
        <div className="bento-card bg-slate-950/60 border border-slate-800/80 rounded-xl p-4 flex flex-col justify-between hover:border-slate-700/80 transition-all">
          <div>
            <div className="flex items-center justify-between gap-2 mb-3">
              <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-slate-400">
                <ShieldAlert size={14} className="text-red-400" /> Emergency Contact
              </div>
            ...
            <div className="space-y-2 text-xs">
              <div>
                <div className="text-slate-100 font-bold text-sm">
                  {data.emergencyContactName || data.primaryParentName || 'Primary Emergency Contact'}
                </div>
              ...
              <div className="bg-red-950/30 border border-red-900/40 rounded-lg p-2.5 mt-2">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  >
                    {data.emergencyContactPhone || data.primaryParentPhone || '+91 98840 55123'}
                  </a>
                  <button
                    onClick={() => copyToClipboard(data.emergencyContactPhone || data.primaryParentPhone || '', 'emPhone')}
                    className="text-slate-400 hover:text-white p-1 rounded hover:bg-slate-800 transition-colors"
                  >
                    {copiedKey === 'emPhone' ? <Check size={12} className="text-emerald-400" /> : <Copy size={12} />}
                  </button>
                </div>
              </div>
            </div>
          ...
          <div className="mt-3 pt-2.5 border-t border-slate-800/80 text-[11px] text-slate-400 flex items-center justify-between">
            ...
            <span className="text-emerald-400 font-medium">Verified for 2026–27</span>
          </div>
        </div>
        ...
        <div className="bento-card bg-slate-950/60 border border-slate-800/80 rounded-xl p-4 flex flex-col justify-between hover:border-slate-700/80 transition-all">
            ...
            <div className="space-y-2.5 text-xs">
              <div>
                <div className="text-[11px] text-slate-400 font-medium flex items-center gap-1">
                  <Bus size={12} className="text-teal-400" /> Daily Commute Route
                </div>
                <div className="text-slate-200 font-medium mt-0.5">
                  {data.transportMode || data.busRoute || 'School Bus #12 (Route 4 - Anna Nagar)'}
                </div>
              </div>

              <div>
                <div className="text-[11px] text-slate-400 font-medium flex items-center gap-1">
                  <AlertCircle size={12} className="text-amber-400" /> Medical & Allergies
                </div>
              ...
              <div>
                <div className="text-[11px] text-slate-400 font-medium">Dietary Preference</div>
          ...
          <div className="mt-3 pt-2.5 border-t border-slate-800/80 flex items-center justify-between text-[11px]">
            ...
            <span className="text-teal-400 font-mono font-medium">BC-{data.studentId?.slice(-4) || '9821'}</span>
          </div>
        </div>
      </div>
